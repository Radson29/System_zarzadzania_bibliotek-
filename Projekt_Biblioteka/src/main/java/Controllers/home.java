...
public void liczbaKsiazek() throws SQLException {
    ...
    CallableStatement cstmt = con.prepareCall("{ ?= call STATYSTYKI_TAPI.COUNTBOOKS()}");
    ...
    public void liczbaCzytelnikow() throws SQLException {
        ...
        Connection con = ConnectionDB.getConnection();
        CallableStatement cstmt = con.prepareCall("{ ?= call STATYSTYKI_TAPI.COUNTREADERS()}");
        cstmt.registerOutParameter(1, Types.INTEGER);
        cstmt.execute();
        int result = cstmt.getInt(1);
    ...
    public void liczbaWypozyczen() throws SQLException {
        ...
        Connection con = ConnectionDB.getConnection();
        CallableStatement cstmt = con.prepareCall("{ ?= call STATYSTYKI_TAPI.COUNTISSUE()}");
        cstmt.registerOutParameter(1, Types.INTEGER);
        cstmt.execute();
        int result = cstmt.getInt(1);
    ...
    public void czarnaLista() throws SQLException {
        ...
        Connection con = ConnectionDB.getConnection();
        CallableStatement cstmt = con.prepareCall("{ ?= call STATYSTYKI_TAPI.COUNTDEFAULTER()}");
        cstmt.registerOutParameter(1, Types.INTEGER);
        cstmt.execute();
        int result = cstmt.getInt(1);
    ...
    public void bestseller() throws SQLException {
      ...
      CallableStatement cstmt = con.prepareCall("{call STATYSTYKI_TAPI.SELECTBEST(?)}");
...
public void chartFunction() {
    try {
        Connection con = ConnectionDB.getConnection();
        CallableStatement cstmt = con.prepareCall("{call STATYSTYKI_TAPI.SELECTREVIEW(?)}");
        cstmt.registerOutParameter(1, OracleTypes.CURSOR);
        cstmt.execute();
        ResultSet rs = (ResultSet) cstmt.getObject(1);
while(rs.next()){
